...
export class CountryComponent implements OnInit {
  ...
  columnDefs3 = [
    ...
    { headerName: 'Department Code', field: 'departmentCode', sortable: true, filter: true, editable:true, width: 200 },
    { headerName: 'Department Name', field: 'department', sortable: true, filter: true, editable:true, width: 200 }
     ];
